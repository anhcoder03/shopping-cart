...
})({"fnpr8":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "51d766babd0d0721";
"use strict";
...
},{}],"bs9zO":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    productService.getProductById(id).then((data)=>{
        ...
        categoryService.getCategoryAll().then((data)=>{
            for(const key in data){
                const el = data[key];
                const template = `<option value="${key}" ${categoryId === key ? "selected" : ""}  class="category-item">${el.name}</option>`;
    ...
    updateBtn.addEventListener("click", (e)=>{
        e.preventDefault();
        if (productName.value == "" || image.value == "" || price.value == "" || description.value == "" || quantity.value == "") {
            const template = `
        ...
        const product = new (0, _productDefault.default)(categoryList.value, null, productName.value, description.value, price.value, image.value, quantity.value);
        try {
...
},{"regenerator-runtime/runtime":"dXNgZ","../../firebase/config":"7nU9T","../../helpers/UrlHelper":"bSskj","../../models/Product":"lrZbj","../../services/CategoryService":"ddUVJ","../../services/ProductService":"5BxuJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bSskj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lrZbj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Product {
    constructor(categoryId, productId, productName, description, price, image, quantity){
...
class ProductService {
    ...
    updateProduct = async (id, entity)=>{
        const res = await (0, _axiosDefault.default).put(`${this.realtimeDb}products/${id}.json`, entity);
        return res.data;
    };
    deleteProduct = async (id)=>{
        const res = await (0, _axiosDefault.default).delete(`${this.realtimeDb}products/${id}.json`);
        return res.data;
    };
    getProductById = async (id)=>{
        const res = await (0, _axiosDefault.default).get(`${this.realtimeDb}products/${id}.json`);
        return res.data;
    };
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fnpr8","bs9zO"], "bs9zO", "parcelRequire8cd9")

//# sourceMappingURL=editProduct.bd0d0721.js.map
