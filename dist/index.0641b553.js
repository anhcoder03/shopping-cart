    ...
    try {
        productService.getProductAll().then((data)=>{
            for(const key in data){
                const el = data[key];
                const productList = document.querySelector(".product-new");
                const template = `
        <div class="product-item">
        <div class="product-image">
           <a href="./pages/productDetail.html?id=${key}"><img src="${el.image}" alt=""></a>  
        </div>
        <div class="product-content">
           <a href="./pages/productDetail.html?id=${key}" data-id="${key}" class="product-name">${el.productName}</a> 
           ...
           <a href="./pages/productDetail.html?id=${key}" class="mua-ngay">Mua Ngay</a>
        </div>
     </div>`;
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire8cd9")
